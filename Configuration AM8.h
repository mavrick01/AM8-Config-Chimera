...
#define STRING_CONFIG_H_AUTHOR "(mgollop, AM8 config, 31 Aug 2020)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Second SKR 
  // #define DEFAULT_Kp 36.93
  // #define DEFAULT_Ki 4.31
  // #define DEFAULT_Kd 79.15
  // Ultimaker
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Stock ANet A8 Bed PID
  #define DEFAULT_bedKp 465.23
  #define DEFAULT_bedKi 73.75
  #define DEFAULT_bedKd 733.67
...
/**
 * Use d2 to probe the bed with the nozzle.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -14, -3.3 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 6  // was 3
